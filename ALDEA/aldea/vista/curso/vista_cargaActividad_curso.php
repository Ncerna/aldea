...
<script type="text/javascript" src="../js/cargasAcademicos.js?rev=<?php echo time();?>"></script>


<div class = "col-md-7" id="div_activiti_cursotable" >
  <div class = "box box-warning">
    <div class = "box-header with-border" id="Titulo_Center" >
      <h5 class = "box-title">Lista de cursos con Cargas Académicos</h5>
    </div>  
    <div class="box-body">
...
<div class = "col-md-5" id="div_ponderado_table" >
  <div class = "box box-warning">
    <div class = "box-header with-border" id="Titulo_Center" >
      <h3 class = "box-title">Criterios ha evaluar en cada curso</h3>
    </div>  
    <div class="box-body">
...
<div class="col-md-12" id="DivActividades" style="display: none">
  <div class="box box-warning ">
    <div class="box-header with-border">
      <h3 class="box-title" style="text-align: center;"><center>Actividades para la evaluación</center></h3>
    </div>

...
<div class="col-md-12" >
  <div class="box box-warning ">
    <div class = "box-header with-border" id="Titulo_Center" >
      <h5 class = "box-title"><strong>Reporte de notas académicas - <?php echo date('Y'); ?></strong></h5>
    </div>
    <!-- /.box-header -->
    <div class="box-body">
     ...
     <div class="row">
       <div class="col-xs-12">
        <div class="col-md-4">
          ...
          <select class="js-example-basic-single" name="state" id="rep_cbm_grado" style="width:100%; "onchange="ShowSelectedCursos_docente();" >
...
listar_Combo_tipos_report_docente();
YearAcademicoActivo();
 initializeDataTable();

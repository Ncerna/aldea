...
<script type="text/javascript" src="../js/docente_alfabetic.js?rev=<?php echo time();?>"></script>

<div class="col-md-12" id="DivTableAlumno">
  <div class="box box-warning ">
   <div class="box-header with-border" id="Titulo_Center">
    <h5 class="box-title"><strong>Críterios para Libretas de Notas Alfabéticos</strong></h5>
...
<div class="col-md-12" id="Div_boletaNotas" style="display: none">
  <div class="box box-warning ">
    <div class="box-header with-border">
      ...
      <h3 class="box-title" style="text-align: center;"><strong>Calificaciones finales alfabéticos (A,B,C)  </strong></h3>
    </div>
    <!-- /.box-header -->

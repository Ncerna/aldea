...
<div class="col-md-12" >
  <div class="box box-warning ">
    <div class = "box-header with-border" id="Titulo_Center" >
      <h3 class = "box-title">Lista Reportes notas Tipo de evaluación</h3>
    </div>
    <!-- /.box-header -->
    <div class="box-body">
     ...
     <div class="row">
       <div class="col-xs-12">
        ...
        <select class="js-example-basic-single" name="state" id="couses_degree_"  style="width:100%;"> </select><br><br>
        </div>
        <div class="col-md-3">
       ...
       <input type="text" name="" class="form-control" id="txt_nivel_nivel" disabled value=" <?php echo !isset($nombreNivel)?? '' ; ?> ">
        ...
        <div class="col-md-3">
          ...
          <input type="text" name="" class="form-control" id="text_seccion" disabled  value=" <?php echo  !isset($idsecion)?? '' ; ?> ">&nbsp;
           <button onclick="Consultar_Parametros_Docente();" class="btn-sm" id="btn_bucar_data"> <em class="fa fa-search" ></em> </button>
         </div>
        </div>
      </div>
    </div>

...
<div class="col-md-12" id="DivSelectEnFases"  >
  <div class="box box-warning ">
    <div class = "box-header with-border" id="Titulo_Center" >
      <h5 class = "box-title"><strong>Registro de notas académicas - <?php echo date('Y'); ?></strong></h5>
    </div>
    <div class="box-body">
...
<div class="row">
 <div class="col-xs-12" >
  <div class="col-xs-4">
    ...
    <label for="">Periodo (Bim,Tri,Sem)</label>
...
<script type="text/javascript">
 ...
 async function ShowSelectedCursos(){
  var idgrado = $("#cbm_grado").val();
   ...
   if(idgrado){
    listar_Combo_Cursos_grado_Docente(idgrado);
    }
  }

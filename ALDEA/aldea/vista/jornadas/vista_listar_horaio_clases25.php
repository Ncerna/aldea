...
<div class="col-md-12" >
    <div class="box box-warning ">
      ...
      <h3 class = "box-title">Lista de horarios disponibles</h3>
    </div>
            ...
            <div class="col-xs-4 clasbtn_exportar">
              ...
              <div class="col-md-6 pull-right">
                <div class="alin_global">
                 <input type="text" class="global_filter form-control " id="global_filter" placeholder="Ingresar dato a buscar" style=" width: 100%">&nbsp;&nbsp;<button onclick="AbrirModalRegistroHorario();" class="btn-sm" id="but_alin_global" >

...
<body class="app sidebar-mini">
         ...
         <div class="table-responsive text-left" >
          ...
          <table border="1"  class="table table-bordered">
              ...
              <tr>
                  ...
                  $notas = $conn->prepare("select id_Criterio,calificacions,id_curso from  libretanotas where idalumno='$idalumno' and di_year='$id_year' and id_curso=".$curso['curso_id']);
 ...
 <?php 
    ...
    header('Content-Type: application/pdf');
       ...
       $dompdf ->stream("LIBRETA DE NOTAS_".$alumno['apellidos'].' '.$alumno['alumnonombre'].".pdf" ,array('Attachment' => false ));

...
<div class="box box-warning">
  ...
  <div class="box-header with-border">
      <div class="user-block">
        <span class="username" style="margin-left: 0px;"><a href="#"> <i class="fa fa-paper-plane" style="color:#f39c12;"></i> Mensajes enviados</a></span>
      </div>
    ...
    <div class="mailbox-controls" style="display: flex; justify-content: space-between; align-items: center;">
      <div style="flex-shrink: 0;">
        ...
        <button type="button" onclick="loadAndDisplayMessages('',1,10,'send') " class="btn  btn-sm">
...
$(document).ready(function() {
    moment.locale('es');
    loadAndDisplayMessages('', 1, 10,'send');
});

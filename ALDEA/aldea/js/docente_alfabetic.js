...
//////fin de validadcion de vistas////
  ...
  $.each(criterios, function(i, crit) { 
   ...
   html += "<td><input type='text' class='form-control' id='text_criterios'   value='ttttt"+crit.criteriosEvaluacion+"' disabled></td>";
...
function Registrar_Criterios_Notas(kp_codigo,idcurso){
  ...
  $.ajax({
    url: "../controlador/docenteSesion/controller_Notas_Registro_Alfabeticos.php",
    type: 'POST',

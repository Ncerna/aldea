...
async function lista_combo_filtrados_edit(id){
 let desarrolladores = temturno.filter(item => item.idgrado == id)
 $("#edit_txt_nivelId").val(desarrolladores[0][2]);
 $("#edit_txt_nivel_nivel").val(desarrolladores[0][3]);
 $("#edit_text_seccion").val(desarrolladores[0][4]);  
} 
...
async function lista_combo_filtrados_Elimiar(id){
 let desarrolladores = temturno.filter(item => item.idgrado == id)
 $("#elim_txt_nivelId").val(desarrolladores[0][2]);
 $("#elim_text_seccion").val(desarrolladores[0][4]);  

 $("#elim_txt_nivel_nivel_seccion").val(desarrolladores[0][3]+' | '+desarrolladores[0][4]);
} 

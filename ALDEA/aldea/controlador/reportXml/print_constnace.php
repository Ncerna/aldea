    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="text-block">
                Quien suscribe,  <strong><?php echo "Prof/Director.".$school['directors'] ?? ""; ?></strong>, cédula de identidad <strong>
                    <?php echo "CI.- ".$school['identity'] ?? ""; ?></strong>, Director (E) del
                Instituto Técnico “INSTITUTO SUPERIOR LAS CATARATAS”, hace constar que el/la alumno(a): <strong>
                    <?php echo $student['student'] ?? ""; ?></strong>  cédula de identidad No <strong>
                        <?php echo $student['cedula'] ?? ""; ?></strong> , está inscrito en esta casa de
                estudios para cursar <strong><?php echo $student['degreName'] ??  "";  echo $student['section'] ?? "";  ?>
            </strong>  de <?php echo intval($student['id']) <= 3 ? "Educación Media General" : "Educación Media Técnica Profesional"; ?>,
             durante el año
                lectivo <strong><?php echo $student['currenYear'] ?? "" ?></strong> , que abarca el período Enero -Disiembre .
                Constancia que se expide a petición de parte interesada en Ciudad del Este , <strong><?php echo $fechaActual; ?></strong>.

                <br><br>
                <strong>Nota: </strong> La constancia debe presentarla en el plantel acompañada de la planilla de inscripción
                actualizada y la cédula de identidad para su validación. Esta Constancia no tiene validez, si se
                comprueba algún tipo de alteración, si no lleva el sello húmedo del plantel, la firma autorizada
                y los datos de dirección y teléfono de la institución.
            </div>
            ...
            <div class="signature-seal-container">
                ...
                <div class="signature">
                    ...
                    <p>Prof. <?php echo  $school['directors']; ?></p>
                    <p>C.I.V.- <?php echo  $school['identity']; ?></p>
                    <p>Director (E)</p>
                </div>
                
                <!-- Sello alineado a la derecha -->
                <div class="seal">
                    <p>SELLO IDENTIFICADOR </p>
        ...
        <div class="footer">
            ------------------------------------------------------------------------------------------------------------------------------------------------------------<br><br>
            B.FATIMA,Entre Joel Lefebre y Che Sy Hasy, Instituto Superior Las CATARATAS , A una cuadra de la super carretera Avda GRAL Bernardino Caballero.
            De Ciudad del Este, Distrito Alto Parana. | +595 (991) 200-404 | Institutodelascataratas.edu.py
        </div>
    </body>
    </html>
    <?php
